...
For Hardhat setup and usage, refer to the [initial project setup spec](specs/001_initial_project_setup.md) which includes details on the on-chain configuration and testing approach. 
